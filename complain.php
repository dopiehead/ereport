...
<div class="container">
     ...
     <div class="complain-container">
         ...
         <img class="user_image mr-2 mb-2" src="assets/images/IMG_E7548.jpg" alt=""><span class="user_name">Name</span>
            ...
            <textarea name="message" style="font-size:13px;" id="message" class="form-control" wrap="physical" placeholder="...Write a complain" rows="5" ></textarea> 
       ...
       <br><br>
         ...
         <div class="complain-comment-section">
