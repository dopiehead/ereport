...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkLikeQuery = "SELECT COUNT(*) FROM report_likes_unlikes WHERE user_id = ? AND protest_id = ?";
    ...
    if ($likeCount == 0) {
        ...
        echo "You have not liked this protest"; // Or any appropriate message for not found
        $conn->close();
        exit();
    }
